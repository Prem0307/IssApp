...
import {Alert, Text, View ,ImageBackground,StyleSheet,StatusBar,SafeAreaView, Platform,Image} from 'react-native';
        ...
        return (
            <View
                style={
                    ...
                    <ImageBackground source={require('../assets/iss_bg.jpg')}style={styles.issBg}>
